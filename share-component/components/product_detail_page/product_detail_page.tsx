...
const Product_detail_page = () => {
  ...
  useEffect(() => {
    ...
    const matched = all_products.find((i) => i.slug === slug) ?? null;
    setFoundProduct(matched as IProductsType | null);
    ...
    return (
      <div className={style.main_cont}>
        <p style={{ padding: '2rem', textAlign: 'center' }}>
          Product not found for slug: <strong>{slug}</strong>
        </p>
      </div>
    )
  }

  const savings = foundProduct.cut_price - foundProduct.real_price;
        ...
        <div className={style.conatiner}>
          ...
          <div className={style.text_cont}>
            ...
            <div className={style.pricing_sec}>
              <p className={style.orignal_price}>
                Rs.{foundProduct.cut_price.toLocaleString()}.00
              </p>
              <p>Rs.{foundProduct.real_price.toLocaleString()}.00</p>
              <span>Save Rs.{savings.toLocaleString()}.00</span>
            </div>
